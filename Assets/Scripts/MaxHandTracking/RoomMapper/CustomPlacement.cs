...
{
    public class CustomPlacement : RoomMapperDemoState
    {
        //Public Variables:
        ...
        protected override void Update()
        {
            ...
            if (Physics.Raycast(_rig.rightControllerAnchor.position, _rig.rightControllerAnchor.forward, out hit))
            {
                ...
                if (OVRInput.GetDown(OVRInput.Button.PrimaryIndexTrigger, OVRInput.Controller.RTouch))
                {
                    ...
                    {
                        //floor:
                        floorContent.transform.position = hit.point;
                        floorContent.transform.forward = -Vector3.ProjectOnPlane(_rig.rightControllerAnchor.forward, Vector3.up).normalized; //face controller
                        floorContent.transform.parent = RoomAnchor.Instance.transform;
                        floorContent.SetActive(true);
                    }
